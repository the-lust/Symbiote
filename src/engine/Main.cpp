...
static void SetupIatHooks(bool enableEat = false)
{
    ...
    ProxyDll dlls[] = {
        ...
        { L"xgameruntime.dll", nullptr, {{"xgameruntime.dll", "XGameRuntimeInitialize"}, {"xgameruntime.dll", "XUserGetGamertag"}, {"xgameruntime.dll", "XUserGetGamertagUtf16"}, {"xgameruntime.dll", "XUserGetTokenAndSignature"}, {"xgameruntime.dll", "XSystemGetAnalyticsInfo"}, {"xgameruntime.dll", "XSystemGetXboxLiveSandboxId"}, {"xgameruntime.dll", "XSystemGetConsoleId"}, {"xgameruntime.dll", "XStoreQueryProductsAsync"}, {"xgameruntime.dll", "XStoreCanAcquireLicenseForProductAsync"}, {"xgameruntime.dll", "XStoreQueryGameLicenseAsync"}, {"xgameruntime.dll", "XStoreQueryGameLicenseResult"}, {"xgameruntime.dll", "XStoreQueryAddOnLicensesAsync"}, {"xgameruntime.dll", "XStoreQueryLicenseTokenAsync"}, {"xgameruntime.dll", "XStoreQueryLicenseTokenResult"}, {"xgameruntime.dll", "XStoreGetLicenseEntitlementIdAsync"}, {"xgameruntime.dll", "XStoreGetLicenseSkuIdAsync"}}, 16 },
    };
