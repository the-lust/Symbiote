...
| **ThreadHider** | `emu/ThreadHider.cpp/.h` | 12-byte inline hooks on kernel32!CreateToolhelp32Snapshot/Thread32First/Thread32Next; SYSTEM_PROCESS_INFORMATION thread filtering wired to ProcessEmu |
...
| Thread filtering in NtQuerySystemInformation | ThreadHider HandleSystemProcessInformation wired into ProcessEmu synthetic buffer | Done (Phase B) |
